...
def main():
    ...
    parser.add_argument(
        '--repo-url',
        default='https://github.com/Queeenace/Fundamentals-of-Data-Mining/tree/main/1',
    )
    ...
    add('В каталоге отдельно размещены исходный код, данные, тесты, полные результаты, рисунки и программа для создания отчёта. Команды запуска приведены в README.md.')
